                            ...
                            bool enable_mpi_threads)
{
    ...
    ompi_mtl_ofi_send_symtable_init(&ompi_mtl_ofi.sym_tables.send_sym);
    ompi_mtl_ofi.base.mtl_send =
        ompi_mtl_ofi.sym_tables.send_sym.ompi_mtl_ofi_send[ompi_mtl_ofi.fi_cq_data];

    ompi_mtl_ofi_isend_symtable_init(&ompi_mtl_ofi.sym_tables.isend_sym);
    ompi_mtl_ofi.base.mtl_isend =
        ompi_mtl_ofi.sym_tables.isend_sym.ompi_mtl_ofi_isend[ompi_mtl_ofi.fi_cq_data];

    ompi_mtl_ofi_irecv_symtable_init(&ompi_mtl_ofi.sym_tables.irecv_sym);
    ompi_mtl_ofi.base.mtl_irecv =
        ompi_mtl_ofi.sym_tables.irecv_sym.ompi_mtl_ofi_irecv[ompi_mtl_ofi.fi_cq_data];

    ompi_mtl_ofi_iprobe_symtable_init(&ompi_mtl_ofi.sym_tables.iprobe_sym);
    ompi_mtl_ofi.base.mtl_iprobe =
        ompi_mtl_ofi.sym_tables.iprobe_sym.ompi_mtl_ofi_iprobe[ompi_mtl_ofi.fi_cq_data];

    ompi_mtl_ofi_improbe_symtable_init(&ompi_mtl_ofi.sym_tables.improbe_sym);
    ompi_mtl_ofi.base.mtl_improbe =
        ompi_mtl_ofi.sym_tables.improbe_sym.ompi_mtl_ofi_improbe[ompi_mtl_ofi.fi_cq_data];
